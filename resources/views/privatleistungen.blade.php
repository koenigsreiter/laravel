...
<main>
    <nav class="leistungen-detail-nav">
        ...
        <div class="wrapper-headline">
            ...
            <h1 class="h1_privat">Privatleistungen <br> & <br> Ganzheitsmedizin</h1>
...
<section>
    ...
    <div class="headline">
        <i class=" fa fa-heartbeat hell"></i> <h2 class="vorsorge_h2 mitte">Womit sich die Ganzheitsmedizin<br> beschäftigt</h2>
    </div>
